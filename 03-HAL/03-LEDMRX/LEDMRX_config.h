...
#define LEDMRX_COL2_PIN         MGPIO_PORT_B,MGPIO_PIN_5
#define LEDMRX_COL3_PIN         MGPIO_PORT_B,MGPIO_PIN_6
#define LEDMRX_COL4_PIN         MGPIO_PORT_B,MGPIO_PIN_7
#define LEDMRX_COL5_PIN         MGPIO_PORT_B,MGPIO_PIN_8
#define LEDMRX_COL6_PIN         MGPIO_PORT_B,MGPIO_PIN_9
#define LEDMRX_COL7_PIN         MGPIO_PORT_B,MGPIO_PIN_10
